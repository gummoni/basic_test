...
static char* ser_msgs[] = {
	...
	"SENDER,AXIS_Z1,W:11,IF I==11 *FIN1 12\n",
	...
	"SENDER,AXIS_Z1,W:18,INVOKE USER I\n",
	"SENDER,AXIS_Z1,W:19,RETURN\n",
	"SENDER,AXIS_Z1,W:20,GOTO 12\n",
	"SENDER,AXIS_Z1,W:21,*FIN1\n",
	"SENDER,AXIS_Z1,W:22,C$=\"A==1 & B==1\"\n",
	"SENDER,AXIS_Z1,W:23,IF C$ 24 25\n",
	"SENDER,AXIS_Z1,W:24,END\n",
	"SENDER,AXIS_Z1,W:25,A=1\n",
	"SENDER,AXIS_Z1,W:26,B=1\n",
	"SENDER,AXIS_Z1,W:27,GOTO 22\n",
	"SENDER,AXIS_Z1,S:10\n",
